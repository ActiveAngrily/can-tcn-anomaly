"""
Anomaly Injector Tool

This script acts as a 'Chaos Monkey' for the simulation. It connects to the CARLA
server, locates the ego vehicle, and forces erratic steering behavior to simulate
a vehicular cyber-attack or mechanical failure. This allows us to test if the
TCN anomaly detector properly identifies the unexpected behavior.
"""
import carla
import time
import random
